// <copyright file="WinptyNativeInterop.cs" company="JSSoft">
...
internal static class WinptyNativeInterop
{
    ...
    [DllImport(
        WinptyNativeDll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    [return: MarshalAs(
        UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(WinptyLpwstrMarshaler))]
