// <copyright file="PlatformServices.cs" company="JSSoft">
...
internal static class PlatformServices
{
    ...
    private static readonly Dictionary<string, string> UnixPtyEnvironment
    ...
    /// <summary>
    /// Gets the comparer to determine if two environment variable keys are equivalent
