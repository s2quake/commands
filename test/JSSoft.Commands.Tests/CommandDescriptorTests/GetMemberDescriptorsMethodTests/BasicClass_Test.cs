...
public sealed class BasicClass_Test
{
    ...
    {
        var memberDescriptors = GetMemberDescriptors(this, nameof(Method_WithParam1));
    ...
    {
        var memberDescriptors = GetMemberDescriptors(this, nameof(Method_WithParam2));
    ...
    {
        var memberDescriptors = GetMemberDescriptors(this, nameof(Method_WithParam1_WithProperty1));
    ...
    {
        var memberDescriptors = GetMemberDescriptors(this, nameof(Method_WithParam1_WithProperty2));
    ...
    {
        var memberName = nameof(Method_WithParam1_WithProperty2_WithStaticProperty1);
        var memberDescriptors = GetMemberDescriptors(this, memberName);
    ...
    {
        var memberName = nameof(Method_WithParam1_WithProperty2_WithStaticProperty2);
        var memberDescriptors = GetMemberDescriptors(this, memberName);
    ...
    {
        var memberDescriptors = GetMemberDescriptors(this, nameof(StaticMethod_WithParam1));
    ...
    {
        var memberDescriptors = GetMemberDescriptors(this, nameof(StaticMethod_WithParam2));
    ...
    {
        var memberName = nameof(StaticMethod_WithParam1_WithProperty1);
        var memberDescriptors = GetMemberDescriptors(this, memberName);
    ...
    {
        var memberName = nameof(StaticMethod_WithParam1_WithProperty2);
        var memberDescriptors = GetMemberDescriptors(this, memberName);
...
#pragma warning restore MEN002 // Line is too long
    {
        var memberName = nameof(StaticMethod_WithParam1_WithProperty2_WithStaticProperty1);
        var memberDescriptors = GetMemberDescriptors(this, memberName);
...
#pragma warning restore MEN002 // Line is too long
    {
        var memberName = nameof(StaticMethod_WithParam1_WithProperty2_WithStaticProperty2);
        var memberDescriptors = GetMemberDescriptors(this, memberName);
