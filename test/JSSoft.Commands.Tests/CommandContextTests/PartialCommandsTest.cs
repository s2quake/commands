...
public class PartialCommandsTest
{
    ...
    private sealed class TestCommandContext : CommandContextBase
    {
    ...
    [PartialCommand]
    private sealed class PartialCommand1 : CommandMethodBase
    {
    ...
    [PartialCommand]
    private sealed class PartialCommand2 : CommandMethodBase
    {
