...
the execution.
This project provides examples of various commands that can be utilized with a command string, so 
be sure to compare the functionality of each command with your own code to see how it can be 
utilized.
""")]
